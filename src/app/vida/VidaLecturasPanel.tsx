  ...
  <div className={`${styles.panel} ${styles.panelLecturas}`}>
    <div className={`${styles.panelHeader} ${styles.panelHeaderLecturas}`}>
      <div className={styles.panelHeaderText}>
        ...
        <div className={styles.panelSubtitleGold}>Los libros no caben en 3D. Viven en su propia página.</div>
      </div>
      <button onClick={onClose} className={`${styles.closeBtn} ${styles.closeBtnGold}`} aria-label="Cerrar">
        ×
      </button>
    </div>
