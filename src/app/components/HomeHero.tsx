  ...
  return (
    <div className='home-hero'>
        <div className="container">
            <div className="mw-48">
                <h1>Mi blog</h1>
                <h2 className='mb-2'>Aprendo cosas, experimento y te las cuento: Programación, deportes, salud, lutheria, guitarras, idiomas, viajes, fotografía, ...</h2>
                ...
                <div className="d-flex gap-1">
                    <a href="" className="btn btn-primary"><span>Venga, leamos</span></a>
